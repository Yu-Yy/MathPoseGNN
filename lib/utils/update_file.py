...
path_dir = '/Extra/panzhiyu/CampusSeq1/smap_result.pkl'
...
for per_result in tqdm(result):
    ...
    image_num = int(init_image.split('/')[-1].split('-')[-1].split('.png')[0])
    new_result[view_k][image_num] = per_result


new_file = '/Extra/panzhiyu/CampusSeq1/smap_result_new.pkl'
