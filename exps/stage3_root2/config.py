...
class Config:
    ...
    OUTPUT_DIR = osp.join(ROOT_DIR, 'model_logs_1020', osp.split(osp.split(osp.realpath(__file__))[0])[1])
    ...
    TEST.JSON_PATH = osp.join(TEST.ROOT_PATH, 'cmu_data_test.pkl') #  campus_meta_multi.pkl '' cmu_data_train_new5_multi.pkl  cmu_data_test_multi.pkl  cmu_data_gnn_new5temp1_multi.pkl
